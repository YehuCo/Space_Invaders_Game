...
class SpaceInvaders:
    ...
    def _check_play_button(self, mouse_pos):
        ...
        if button_clicked and not self.stats.game_active:
            ...
            # Generate new fleet and center ship
            self._create_fleet()
    ...
    def _check_keyup_events(self, event): # helper method
    ...
    def _create_fleet(self):
        ...
        # Make an alien & find number of aliens in a row (spacing between each alien = 1 alien width)
        alien = Alien(self)
    ...
    def _create_alien(self, alien_num, row_number):
        ...
        alien.rect.y = 30 + alien_height + 2 * alien_height * row_number
    ...
    def _update_aliens(self):
        """Check if fleet hit edges then update positions of all alines in fleet"""
